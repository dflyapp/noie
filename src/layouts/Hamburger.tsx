...
const solutions = [
  ...
  },
  {
    ...
    description: 'TRÃI NGHIỆM KHÔNG GIAN',
    href: 'quy-trinh-thiet-ke',
    icon: IconTwo,
  },
  {
    name: 'Quy Trình Thi Công',
    description: 'CHẤT LƯỢNG VÀ TỐI ƯU',
          ...
          <>
            <Popover.Button
              className={`
                ...
                bg-orange-700 group inline-flex items-center rounded-md border px-3 py-2 text-base font-medium text-white hover:text-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75`}
            >
              <svg
            ...
            >
              <Popover.Panel className="absolute top-20 right-0 z-10 w-screen pl-8">
